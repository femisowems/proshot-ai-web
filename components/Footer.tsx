    ...
    return (
        <footer className="py-4 sm:py-8 px-6 text-center text-gray-400 text-xs border-t border-gray-100 mt-auto">
            ...
            <div className="mt-2 flex flex-row justify-center gap-4">
                ...
                <span className="bg-green-100 text-green-700 text-[10px] px-2 py-0.5 rounded-full font-medium self-center">v1.1.0 • {new Date().toLocaleString('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' })}</span>
            </div>
        </footer>
    );
};
